...
//  Топ-10 локаций по количеству пострадавших в ДТП
export default function VictimsByLocation({ filters }) {
  const { data, loading } = useStat(
    () => statsApi.byLocation(10, filters),
  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <BarChart data={data} layout="vertical" margin={{ left: 20, right: 20 }}>
        ...
        <YAxis type="category" dataKey="location" width={200} tick={{ fontSize: 11 }} />
        <Tooltip />
